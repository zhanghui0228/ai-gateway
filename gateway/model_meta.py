...
_META = [
    ...
    # AgentRouter 公益站
    ("claude-opus-4-8", 200000, 32000, 27.14, 135.71),
    ("claude-opus-5", 200000, 32000, 13.57, 67.85),
    ("gpt-5.6-sol", 400000, 128000, 27.14, 135.71),
    ("glm-5.3", 131072, 98304, 2.5, 12.5),
    ("deepseek-v4-flash", 131072, 8192, 1.0, 3.0),
    # 嵌入
